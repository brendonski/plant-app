<script lang="ts">
	...
	function handleRemove(bedId: string) {
		if (confirm('Are you sure you want to remove this bed? This action cannot be undone.')) {
...
<div class="beds-page">
	<div class="header">
		...
		<button class="btn-primary" onclick={() => (showAddForm = true)}>+ Add Bed</button>
	</div>
			...
			{#each bedsStore.beds as bed (bed.id)}
				<div class="bed-card">
					...
					<div class="bed-details">
						...
						<p><strong>Positions per row:</strong> {bed.positionsPerRow}</p>
					...
					<div class="bed-actions">
						<button class="btn-secondary" onclick={() => handleEdit(bed.id)}>Edit</button>
						<button class="btn-danger" onclick={() => handleRemove(bed.id)}>Remove</button>
					</div>
				</div>
			{/each}
		</div>
