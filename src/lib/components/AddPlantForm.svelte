<script lang="ts">
    ...
    function validate() {
        ...
        const existingPlant = plantsStore.getByLocation(
            selectedBedId,
            selectedRow,
            selectedPosition,
        );
...
<form onsubmit={handleSubmit}>
    ...
    <div class="form-group">
        ...
        <textarea
            id="notes"
            bind:value={notes}
            placeholder="Add any notes about this plant (care instructions, planting date, etc.)"
            rows="4"
        ></textarea>
        <small
            >Optional - Add care instructions, planting dates, or other
            observations</small
        >
    </div>
